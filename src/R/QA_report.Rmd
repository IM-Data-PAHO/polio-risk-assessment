...
```{r rev_data_2, echo=F}
data_sheet_2 <- read_excel(
  PATH_country_data, sheet = 2, col_types = c(
...
data_sheet_3 <- read_excel(
  PATH_country_data, sheet = 3, col_types = c(
...
test_data_sheet_3 <- read_excel(
  PATH_country_data, sheet = 3, skip = 1
)
colnames(test_data_sheet_3) <- c(
  "ADMIN1 GEO_ID","GEO_ID","ADMIN1","ADMIN2",
  'POB1', 'POB5', 'POB15',
   lang_label("immunity_populations_and_pfa"),
   paste(lang_label("immunity_polio_coverage"), YEAR_1),
...
test_data_sheet_3$FILA <- as.numeric(rownames(test_data_sheet_3))+row_offset
test_data_sheet_3 <- test_data_sheet_3 %>% select(FILA,everything())
temp_data_sheet_3 <- test_data_sheet_3
...
idx <- c(1,2,3,idx)
test_table <- test_data_sheet_3[,idx]
...
```{r rev_data_4, echo=F}
data_sheet_4 <- read_excel(
  PATH_country_data,sheet = 4, skip= 1, guess_max = 1000, col_types = c(
    "guess", "guess", "guess", "guess", "numeric", "numeric", "numeric",
    "text", "numeric", "numeric", "numeric", "numeric", "numeric", "numeric",
    "text"
  )
...
dat_test_na_df4 <- data_sheet_4 %>% 
  mutate(
    ...
    `%  de casos de PFA con notificación oportuna (antes de 14 días desde el inicio de la parálisis)` = case_when(
      population_and_pfa_bool ~ `%  de casos de PFA con notificación oportuna (antes de 14 días desde el inicio de la parálisis)`,
      !population_and_pfa_bool ~ 0
    ),
...
```{r, echo=F}
idx <- c(10)
test_data_sheet_4 <- read_excel(
  PATH_country_data,sheet = 4, skip= 1, guess_max = 1000
)
colnames(test_data_sheet_4) <- c(
  "ADMIN1 GEO_ID","GEO_ID","ADMIN1","ADMIN2",
  'POB1', 'POB5', 'POB15',
  lang_label("immunity_populations_and_pfa"),
  lang_label("surveillance_reporting_units_var"),
...
test_data_sheet_4$FILA <- as.numeric(rownames(test_data_sheet_4))+row_offset
test_data_sheet_4 <- test_data_sheet_4 %>% select(FILA, everything())
temp_data_sheet_4 <- test_data_sheet_4
...
idx <- c(1,2,3,idx)
test_table <- test_data_sheet_4[,idx]
colnames(test_table)[1] = "FILA"
test_table <- test_table %>% filter(FILA %in% non_numeric_rows)
if (nrow(test_table) == 0) {
  test_table <- data.frame(V1="")
...
```{r rev_data_5, echo=F}
data_sheet_5 <- read_excel(
  PATH_country_data,sheet = 5, skip= 1, guess_max = 1000, col_types = c(
    "guess", "guess", "guess", "guess", "numeric", "numeric", "numeric",
...
```{r, echo=F}
idx <- c(10)
test_data_sheet_5 <- read_excel(
  PATH_country_data,sheet = 5, skip= 1, guess_max = 1000
)
colnames(test_data_sheet_5)[1:15] <- c(
  first_colnames[1:4],
  'POB1', 'POB5', 'POB15',
  lang_label("immunity_populations_and_pfa"),
  lang_label("determinants_water_var"),
...
test_data_sheet_5$FILA <- as.numeric(rownames(test_data_sheet_5))+row_offset
test_data_sheet_5 <- test_data_sheet_5 %>% select(FILA,everything())
temp_data_sheet_5 <- test_data_sheet_5
...
idx <- c(1,2,3,idx)
test_table <- test_data_sheet_5[,idx]
colnames(test_table)[1] = "FILA"
test_table <- test_table %>% filter(FILA %in% non_numeric_rows)
if (nrow(test_table) == 0) {
  test_table <- data.frame(V1="")
...
```{r rev_data_6, echo=F}
data_sheet_6 <- read_excel(
  PATH_country_data,sheet = 6, skip = 1, guess_max = 1000, col_types = c(
    "guess", "guess", "guess", "guess", "numeric", "numeric", "numeric",
